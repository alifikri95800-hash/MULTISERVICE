...
import PlumbingPage from '../src/components/pages/PlumbingPage';
...
export default function PlomberiePage() {
  ...
  const navigate = (page: string) => {
    ...
    } else if (page === 'plumbing-emergency') {
      window.location.href = '/plomberie/depannage-urgence';
    } else if (page === 'leak-detection') {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Services de Plomberie Paris",
    "description": "Plombier professionnel à Paris et départements 78, 95, 92, 93. Interventions rapides 24h/7j pour tous vos problèmes de plomberie.",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      <SEO
        title="Services de Plomberie à Paris | MULTISERVICES | Intervention 24h/7j"
        description="Plombier professionnel à Paris et départements 78, 95, 92, 93. Dépannage urgence, recherche de fuites, débouchage, installation. Intervention 24h/7j, devis gratuit."
