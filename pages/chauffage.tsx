...
import HeatingPage from '../src/components/pages/HeatingPage';
...
export default function ChauffagePage() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Services de Chauffage Paris",
    "description": "Chauffagiste professionnel à Paris et départements 78, 95, 92, 93. Entretien chaudière, dépannage, installation. Service 24h/7j.",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      <SEO
        title="Chauffagiste à Paris | MULTISERVICES | Entretien & Dépannage Chaudière"
        description="Chauffagiste professionnel à Paris et départements 78, 95, 92, 93. Entretien chaudière obligatoire, dépannage urgence, installation thermostat. Service 24h/7j, devis gratuit."
        currentPage="heating"
      />
      <Head>
        <script
