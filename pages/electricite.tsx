...
import ElectricalPage from '../src/components/pages/ElectricalPage';
...
export default function ElectricitePage() {
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Services d'Électricité Paris",
    "description": "Électricien professionnel à Paris et départements 78, 95, 92, 93. Dépannage, mise aux normes NF C 15-100, installation. Service 24h/7j.",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      <SEO
        title="Électricien à Paris | MULTISERVICES | Dépannage & Mise aux Normes"
        description="Électricien professionnel à Paris et départements 78, 95, 92, 93. Dépannage électrique, mise aux normes NF C 15-100, installation éclairage, domotique. Service 24h/7j, devis gratuit."
